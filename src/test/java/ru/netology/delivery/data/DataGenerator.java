...
public class DataGenerator {
    ...
    public static String generateCity(String locale) {
        var cities = new String[]{"Майкоп", "Горно-Алтайск", "Уфа", "Улан-Удэ", "Махачкала", "Магас", "Нальчик",
                "Элиста", "Черкесск", "Петрозаводск", "Сывтывкар", "Симферополь", "Йошкар-Ола", "Саранск",
                ...
                "Иркурск", "Калининград", "Калуга", "Кемерово", "Киров", "Кострома", "Курган", "Курск",
    ...
    public static String generateName(String locale) {
        ...
        return faker.name().lastName() + " " + faker.name().
                firstName();
    }
